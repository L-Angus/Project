...
int main(int argc, char *argv[]) {
  ...
  rawDataMap.SetType(RawDataUtils::RawDataType::SIGNAL);
  rawDataMap.SetMode(RawDataUtils::RawDataMode::LOCAL);
  RawDataUtils::SitePinRawData sitePinRawData{};
  IQSignalHandler iqSignalHandler;
  iqSignalHandler.handleData(sitePinRawData);
  rawDataMap.SetHandler(iqSignalHandler);
  rawDataMap.GetData<RawDataUtils::SitePinSignalData>();
